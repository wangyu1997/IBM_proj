...
public class ShowProductController {
    ...
    @Autowired
    public ShowProductController(ProductService productService, FileService fileService, CommentService commentService) {
    ...
    public String product_details(@RequestParam("productID") String productID, Model model) {
        ...
        List<Comment> comments = commentService.getCommentByProduct(product.getProductId());
