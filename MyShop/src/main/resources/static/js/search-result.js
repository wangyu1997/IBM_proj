    ...
    $.post("/searchProductByName",{
        ...
        for(var i=0; i<pages;i++){
            ...
            for(var j =items_no*i; j<ceiling;j++){
                ...
                var new_image = "/images/products/41AQUQfyoxL._SL800_.jpg";
                if (data[j].iamges.length>0)
                    new_image = data[j].iamges[0];
                console.log(new_image);
                div += "<div style=\"height:177px;\"><a href='"+url +"'><img src='" +  new_image +"' alt=\"\" /></a></div>";
                // if("" == image_url){
